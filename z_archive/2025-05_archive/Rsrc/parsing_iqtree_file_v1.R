# source('~/HD/GitHub/str2phy/ex/parsing_iqtree_file_v1.R', chdir = TRUE)
...
read_iqtree_model_scores <- function(iqtree_fn, start_txt = "List of models sorted by BIC scores: ", calc_extra=TRUE, partitioned_TF=FALSE)
	{
	ex='
	# For non-partitioned models, you get the list of model fits
	iqtree_fn = "/GitHub/str2phy/ex/ferritins_M20af/03_USaln_v1/iqtree_BothTrim35_NonPartitioned_allmodels/53fer.fasta.iqtree"
	iqtree_df = read_iqtree_model_scores(iqtree_fn, start_txt="List of models sorted by BIC scores: ", calc_extra=TRUE)
	iqtree_df


	# For partitioned models, you get only the best-fitting models
	iqtree_fn = "/GitHub/str2phy/ex/ferritins_M20af/03_USaln_v1/iqtree_BothTrim35_allmodels/partitions_v1.raxml.iqtree"
	iqtree_df = read_iqtree_model_scores(iqtree_fn, start_txt="List of best-fit models per partition:", calc_extra=TRUE)
	iqtree_df
